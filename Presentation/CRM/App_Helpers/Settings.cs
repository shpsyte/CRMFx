...
namespace CRM.App_Helpers
{
    ...
    public static class Settings
    {
        ...
        public static readonly string caminho_arquivos_procedimento = GetValue<string>("caminho_arquivos_procedimento");

        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:EnableTiles" as a boolean.
        /// </summary>
        public static readonly bool EnableMiniDashborad = GetValue<bool>("EnableMiniDashborad");
        public static readonly bool EnableDashborad = GetValue<bool>("EnableDashborad");
        public static readonly bool EnableNotes = GetValue<bool>("EnableNotes");
        public static readonly bool EnableMkt = GetValue<bool>("EnableMkt"); 
        ...
        public static readonly string cod_situacao_finalizacao = GetValue<string>("cod_situacao_finalizacao");
        public static readonly string cod_situacao_cancelada  = GetValue<string>("cod_situacao_cancelada");
        public static readonly string cod_situacao_ematendimento  = GetValue<string>("cod_situacao_ematendimento");


        public static readonly string cod_garantia_cancelada = GetValue<string>("cod_garantia_cancelada");
