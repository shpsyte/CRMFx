...
namespace b2yweb_mvc4.Areas.Procedimento.Controllers
{
    ...
    public class ProcedimentoAdmController : Controller
    {
        ...
        public JsonResult GetDepartamento()
        {
            ...
            {
                return Json(db.DEPARTAMENTOes.Where(a => a.CD_DEPARTAMENTO == dep_padrao).OrderBy(s => s.DESC_DEPARTAMENTO), JsonRequestBehavior.AllowGet);
            }
        }
                        ...
                        if (a != null)
                        {
                            if (a.ContentLength > 0)
                            {
                                ...
                                ProcedimentoAdmArq doc = new ProcedimentoAdmArq
                                {
                                    ...
                                    CAMINHO = NomeArquivo,
                                    CD_PROCEDIMENTO = procedimentoadm.CD_PROCEDIMENTO,
