...
namespace b2yweb_mvc4.Areas.Procedimento.Controllers
{
    ...
    public class SituacaoController : Controller
    {
        ...
        /// <returns></returns>
		[HttpGet]
		[CustomAuthorize(AccessLevel = "situacaoIndex")]
        ...
        public ActionResult Index(string strPesquisa)
        {
            ...
            }else
            {
                ...
                return View(db.Situacao.Where(a => a.DESCRICAO.Contains(strPesquisa)).ToList());
        ...
        {
            return Json(db.Situacao.ToDataSourceResult(request));
        }
        ...
        //
        // GET: /Procedimento/Situacao/Details/5

		[CustomAuthorize(AccessLevel = "situacaoDetails")]
        ...
        //
        // GET: /Procedimento/Situacao/Create

		[CustomAuthorize(AccessLevel = "situacaoCreate")]
        ...
        //
        // POST: /Procedimento/Situacao/Create
        ...
        //
        // GET: /Procedimento/Situacao/Edit/5

		[CustomAuthorize(AccessLevel = "situacaoEdit")]
        ...
        //
        // POST: /Procedimento/Situacao/Edit/5

        [HttpPost]
		[CustomAuthorize(AccessLevel = "situacaoEdit")]
        public ActionResult Edit(Situacao situacao)
        {
            if (ModelState.IsValid)
            {
        ...
        //
        // GET: /Procedimento/Situacao/Delete/5

		[CustomAuthorize(AccessLevel = "situacaoDelete")]
        ...
        //
        // POST: /Procedimento/Situacao/Delete/5
		...
		[CustomAuthorize(AccessLevel = "situacaofind")]
		...
		[CustomAuthorize(AccessLevel = "situacaoExportXls")]
        public void ExportXls(String strPesquisa)
        {
            ...
            grid.DataSource = from _data in situacao select _data;
            grid.DataBind();
            Response.ClearContent();
            Response.AddHeader("content-disposition", "attachment; filename=situacao.xls");
		...
		[CustomAuthorize(AccessLevel = "situacaoUpload")]
		...
		[CustomAuthorize(AccessLevel = "situacaoSave")]
        ...
        [CustomAuthorize(AccessLevel = "situacaoRemove")]
