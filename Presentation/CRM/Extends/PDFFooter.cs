...
namespace CRM.Extends
{
    public class PDFFooter : PdfPageEventHelper
    {
        ...
        public PDFFooter(string titulo, bool canhoto)
        {
            this.Titulo = titulo;
        ...
        public override void OnOpenDocument(PdfWriter writer, Document doc)
        {
            ...
            iTextSharp.text.Image img = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("~/Content/Logo_P.gif"));
            img.ScalePercent(45);

            Paragraph _TITULO = new Paragraph();
            _TITULO.Alignment = Element.ALIGN_CENTER;
            _TITULO.Add(new Chunk(Titulo, verdana));
            ...
            float[] largura_colunas_coleta = new float[] { 1f, 3f, 1f };
            ...
            Chunk myFooter = new Chunk("DATA IMPRESSÃO" + Chunk.NEWLINE + System.DateTime.Now.ToString(), times);
        ...
        public override void OnEndPage(PdfWriter writer, Document doc)
        {
            ...
            iTextSharp.text.Image foot = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("~/Content/Logo_P.gif"));
