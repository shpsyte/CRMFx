...
namespace CRM
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/scripts/maps").Include(
               "~/scripts/plugin/maps/GoogleMaps.js"
               ));

            bundles.Add(new ScriptBundle("~/scripts/tags").Include(
              "~/scripts/plugin/bootstrap-tags/bootstrap-tagsinput.min.js"
              ));
            ...
            bundles.Add(new ScriptBundle("~/scripts/super-box").Include(
          ...
          "~/Scripts/plugin/AjaxValidate/jquery.unobtrusive-ajax.min.js",
          "~/Scripts/plugin/AjaxValidate/jquery.validate.min.js",
          "~/Scripts/plugin/AjaxValidate/jquery.validate.unobtrusive.min.js"));



            bundles.Add(new ScriptBundle("~/scripts/ptbr").Include(
                     "~/scripts/culture_ptbr/messages_ptbr.js",
                     "~/scripts/culture_ptbr/methods_pt.js",
                     "~/scripts/culture_ptbr/globalize.js",
                     "~/scripts/culture_ptbr/globalize.culture.pt-BR.js"));

            //Javascript para as telas especificas
            bundles.Add(new ScriptBundle("~/bundles/Account").Include(
                    "~/scripts/view/Account.js"));


            bundles.Add(new ScriptBundle("~/bundles/ItensVenda").Include(
                    "~/scripts/view/ItensVenda.js"));
